      ...
      handler(html) {
        try {
          ...
          const metadataPath = resolve(
            process.cwd(),
            "content/settings/metadata.json",
          );
          ...
          if (metadata.openGraph?.description || metadata.site?.description) {
            const ogDescription =
              metadata.openGraph?.description || metadata.site?.description;
